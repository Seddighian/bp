...
let userID = 'b7cba098-994c-4caa-807e-f7cc2740a44b';
...
const generateRemark = (index, port) => {
    ...
    switch (index) {
        case 0:
        case 1:
            remark = `💥 🇸🇬 TUNEL - Domain_${index + 1} : ${port}`;
            break;
        case 2:
        case 3:
            remark = `💥 🇸🇬 TUNEL - IPv4_${index - 1} : ${port}`;
            break;
        case 4:
        case 5:
            remark = `💥 🇸🇬 TUNEL - IPv6_${index - 3} : ${port}`;
            break;
        default:
            remark = `💥 🇸🇬 TUNEL - Clean IP_${index - 5} : ${port}`;
            break;
    }
...
const getWarpConfigs = async (env, client) => {
    ...
    xrayWarpBestPing.remarks = '💥 🇸🇬 TUNEL - Warp Best Ping 🚀'
    ...
    xrayWoWOutbounds.forEach((outbound, index) => {
        if (outbound.tag.includes('warp-out')) {
            ...
            xrayWoWConfig.remarks = `💥 🇸🇬 TUNEL - WoW ${index/2 + 1} 🌍`;
			...
			<div class="table-container">
				<table id="normal-configs-table">
					...
					<tr>
						...
						<td>
                            <button onclick="openQR('https://${hostName}/warpsub/${userID}#TUNEL-Warp', 'Warp Subscription')" style="margin-bottom: 8px;">
                                QR Code&nbsp;<span class="material-symbols-outlined">qr_code</span>
                            </button>
                            <button onclick="copyToClipboard('https://${hostName}/warpsub/${userID}#TUNEL-Warp', false)">
                                Copy Sub<span class="material-symbols-outlined">format_list_bulleted</span>
                            </button>
                        </td>
					</tr>
